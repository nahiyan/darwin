...
void NeuralNetworkTest::test_calculate_outputs()
{
   ...
   assert_true(abs(outputs(0, 0, 0, 0) - 0.992593) < 1e-6 &&
                   ...
                   abs(outputs(1, 2, 2, 2) + 0.998316) < 1e-6,
               LOG);
...
void NeuralNetworkTest::test_calculate_trainable_outputs()
{
   ...
   assert_true(neural_network.calculate_trainable_outputs(inputs) == neural_network.calculate_trainable_outputs(inputs, parameters), LOG);
   ...
   assert_true(neural_network.calculate_outputs(inputs) >= 0 &&
                   neural_network.calculate_outputs(inputs) <= 1,
               LOG);
