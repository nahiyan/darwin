...
namespace OpenNN
{
    ...
    LossIndex::LossIndex(const onntinyxml2::XMLDocument &error_term_document)
        : neural_network_pointer(nullptr),
          data_set_pointer(nullptr)
    {
        set_default();
    ...
    onntinyxml2::XMLDocument *LossIndex::to_XML() const
    {
        ostringstream buffer;
        ...
        onntinyxml2::XMLElement *root_element = document->NewElement("LossIndex");
    ...
    void LossIndex::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        ostringstream buffer;
    ...
    void LossIndex::regularization_from_XML(const onntinyxml2::XMLDocument &document)
    {
        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("Regularization");
        ...
        const onntinyxml2::XMLElement *element = root_element->FirstChildElement("NeuralParametersNormWeight");
    ...
    void LossIndex::write_regularization_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        ostringstream buffer;
    ...
    void LossIndex::from_XML(const onntinyxml2::XMLDocument &document)
    {
        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("MeanSquaredError");
