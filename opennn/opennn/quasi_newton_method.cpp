...
namespace OpenNN
{
   ...
   QuasiNewtonMethod::QuasiNewtonMethod(const onntinyxml2::XMLDocument &document)
       ...
       const Vector<double> &old_parameters, const Vector<double> &parameters, const Vector<double> &old_gradient, const Vector<double> &gradient, const Matrix<double> &old_inverse_hessian) const
   {
      ...
      inverse_hessian_approximation -= direct(hessian_dot_gradient_difference, hessian_dot_gradient_difference) / dot(gradient_difference, hessian_dot_gradient_difference);
       ...
       const Vector<double> &old_gradient, const Vector<double> &gradient, const Matrix<double> &old_inverse_hessian) const
   {
      ...
      const Vector<double> BFGS = parameters_difference / parameters_dot_gradient - hessian_dot_gradient / gradient_dot_hessian_dot_gradient;
      ...
      inverse_hessian_approximation -= direct(hessian_dot_gradient, hessian_dot_gradient) / gradient_dot_hessian_dot_gradient;
   ...
   OptimizationAlgorithm::Results QuasiNewtonMethod::perform_training()
   {
      ...
      for (size_t epoch = 0; epoch <= maximum_epochs_number; epoch++)
      {
         ...
         if (epoch == 0 || absolute_value(old_parameters - parameters) < numeric_limits<double>::min() || absolute_value(old_gradient - gradient) < numeric_limits<double>::min())
         {
   ...
   onntinyxml2::XMLDocument *QuasiNewtonMethod::to_XML() const
   {
      ostringstream buffer;
      ...
      onntinyxml2::XMLElement *root_element = document->NewElement("QuasiNewtonMethod");
   ...
   void QuasiNewtonMethod::write_XML(onntinyxml2::XMLPrinter &file_stream) const
   {
      ostringstream buffer;
   ...
   void QuasiNewtonMethod::from_XML(const onntinyxml2::XMLDocument &document)
   {
      const onntinyxml2::XMLElement *root_element = document.FirstChildElement("QuasiNewtonMethod");
      ...
      // Inverse hessian approximation method
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("InverseHessianApproximationMethod");
      ...
      // Training rate algorithm
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("LearningRateAlgorithm");
      ...
      // Warning parameters norm
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("WarningParametersNorm");
      ...
      // Warning gradient norm
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("WarningGradientNorm");
      ...
      // Warning training rate
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("WarningLearningRate");
      ...
      // Error parameters norm
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ErrorParametersNorm");
      ...
      // Error gradient norm
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ErrorGradientNorm");
      ...
      // Error training rate
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ErrorLearningRate");
      ...
      // Minimum parameters increment norm
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MinimumParametersIncrementNorm");
      ...
      // Minimum loss decrease
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MinimumLossDecrease");
      ...
      // Loss goal
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("LossGoal");
      ...
      // Gradient norm goal
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("GradientNormGoal");
      ...
      // Maximum selection error decreases
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MaximumSelectionErrorIncreases");
      ...
      // Maximum iterations number
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MaximumEpochsNumber");
      ...
      // Maximum time
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MaximumTime");
      ...
      // Reserve training error history
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ReserveTrainingErrorHistory");
      ...
      // Reserve selection error history
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ReserveSelectionErrorHistory");
      ...
      // Display period
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("DisplayPeriod");
