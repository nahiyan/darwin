...
namespace OpenNN
{
   ...
   GradientDescent::GradientDescent(const onntinyxml2::XMLDocument &document) : OptimizationAlgorithm(document)
   {
      set_default();
   ...
   OptimizationAlgorithm::Results GradientDescent::perform_training()
   {
      ...
      for (size_t epoch = 0; epoch <= maximum_epochs_number; epoch++)
      {
         ...
         if (gradient == 0.0)
            throw logic_error("Gradient is zero");
   ...
   onntinyxml2::XMLDocument *GradientDescent::to_XML() const
   {
      ostringstream buffer;
      ...
      onntinyxml2::XMLElement *root_element = document->NewElement("GradientDescent");
      ...
      // Training rate algorithm
      {
         ...
         const onntinyxml2::XMLElement *inputs_element = learning_rate_algorithm_document->FirstChildElement("Inputs");
   ...
   void GradientDescent::write_XML(onntinyxml2::XMLPrinter &file_stream) const
   {
      ostringstream buffer;
   ...
   void GradientDescent::from_XML(const onntinyxml2::XMLDocument &document)
   {
      const onntinyxml2::XMLElement *root_element = document.FirstChildElement("GradientDescent");
