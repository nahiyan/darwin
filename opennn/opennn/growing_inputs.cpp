...
namespace OpenNN
{
    ...
    GrowingInputs::GrowingInputs(const onntinyxml2::XMLDocument &genetic_algorithm_document)
...
*/
    ...
    onntinyxml2::XMLDocument *GrowingInputs::to_XML() const
    {
        ostringstream buffer;
        ...
        onntinyxml2::XMLElement *root_element = document->NewElement("GrowingInputs");
    ...
    void GrowingInputs::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        ostringstream buffer;
    ...
    void GrowingInputs::from_XML(const onntinyxml2::XMLDocument &document)
    {
        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("GrowingInputs");
