...
namespace OpenNN
{
    ...
    onntinyxml2::XMLDocument *ProbabilisticLayer::to_XML() const
    {
        ostringstream buffer;

        onntinyxml2::XMLDocument *document = new onntinyxml2::XMLDocument;

        onntinyxml2::XMLElement *root_element = document->NewElement("ProbabilisticLayer");
...
void ProbabilisticLayer::write_XML(onntinyxml2::XMLPrinter& file_stream) const
{
    ostringstream buffer;
...
*/
    ...
    /*
void ProbabilisticLayer::from_XML(const onntinyxml2::XMLDocument& document)
{
    ostringstream buffer;

    const onntinyxml2::XMLElement* probabilistic_layer_element = document.FirstChildElement("ProbabilisticLayer");
    ...
    // Activation function
    {
        const onntinyxml2::XMLElement* element = probabilistic_layer_element->FirstChildElement("ActivationFunction");
    ...
    // Decision threshold
    {
        const onntinyxml2::XMLElement* element = probabilistic_layer_element->FirstChildElement("DecisionThreshold");
    ...
    // Display
    {
        const onntinyxml2::XMLElement* display_element = probabilistic_layer_element->FirstChildElement("Display");
...
*/
    ...
    void ProbabilisticLayer::from_XML(const onntinyxml2::XMLDocument &document)
    {
        ...
        const onntinyxml2::XMLElement *inputs_number_element = probabilistic_layer_element->FirstChildElement("InputsNumber");
        ...
        const onntinyxml2::XMLElement *neurons_number_element = probabilistic_layer_element->FirstChildElement("NeuronsNumber");
        ...
        const onntinyxml2::XMLElement *activation_function_element = probabilistic_layer_element->FirstChildElement("ActivationFunction");
        ...
        const onntinyxml2::XMLElement *parameters_element = probabilistic_layer_element->FirstChildElement("Parameters");
        ...
        const onntinyxml2::XMLElement *decision_threshold_element = probabilistic_layer_element->FirstChildElement("DecisionThreshold");
