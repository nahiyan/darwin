...
namespace OpenNN
{
   ...
   StochasticGradientDescent::StochasticGradientDescent(const onntinyxml2::XMLDocument &document)
   ...
   onntinyxml2::XMLDocument *StochasticGradientDescent::to_XML() const
   {
      ostringstream buffer;
      ...
      onntinyxml2::XMLElement *root_element = document->NewElement("StochasticGradientDescent");
   ...
   void StochasticGradientDescent::write_XML(onntinyxml2::XMLPrinter &file_stream) const
   {
      ostringstream buffer;
   ...
   void StochasticGradientDescent::from_XML(const onntinyxml2::XMLDocument &document)
   {
      const onntinyxml2::XMLElement *root_element = document.FirstChildElement("StochasticGradientDescent");
