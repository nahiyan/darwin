...
namespace OpenNN
{
    ...
    SumSquaredError::SumSquaredError(const onntinyxml2::XMLDocument &sum_squared_error_document)
...
#pragma omp critical
    ...
    onntinyxml2::XMLDocument *SumSquaredError::to_XML() const
    {
        ...
        onntinyxml2::XMLElement *root_element = document->NewElement("SumSquaredError");
    ...
    void SumSquaredError::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        // Error type
    ...
    void SumSquaredError::from_XML(const onntinyxml2::XMLDocument &document)
    {
        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("SumSquaredError");
