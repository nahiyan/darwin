...
namespace OpenNN
{
   ...
   AdaptiveMomentEstimation::AdaptiveMomentEstimation(const onntinyxml2::XMLDocument &document)
   ...
   OptimizationAlgorithm::Results AdaptiveMomentEstimation::perform_training()
   {
      ...
      if (display)
         cout << "Training with adaptive moment estimator \"Adam\" ...\n";
   ...
   onntinyxml2::XMLDocument *AdaptiveMomentEstimation::to_XML() const
   {
      ostringstream buffer;
      ...
      onntinyxml2::XMLElement *root_element = document->NewElement("AdaptiveMomentEstimation");
   ...
   void AdaptiveMomentEstimation::write_XML(onntinyxml2::XMLPrinter &file_stream) const
   {
      ostringstream buffer;
   ...
   void AdaptiveMomentEstimation::from_XML(const onntinyxml2::XMLDocument &document)
   {
      const onntinyxml2::XMLElement *root_element = document.FirstChildElement("AdaptiveMomentEstimation");
