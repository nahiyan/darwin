...
namespace OpenNN
{
   ...
   LevenbergMarquardtAlgorithm::LevenbergMarquardtAlgorithm(const onntinyxml2::XMLDocument &document)
   ...
   onntinyxml2::XMLDocument *LevenbergMarquardtAlgorithm::to_XML() const
   {
      ostringstream buffer;
      ...
      onntinyxml2::XMLElement *root_element = document->NewElement("LevenbergMarquardtAlgorithm");
   ...
   void LevenbergMarquardtAlgorithm::write_XML(onntinyxml2::XMLPrinter &file_stream) const
   {
      ostringstream buffer;
   ...
   void LevenbergMarquardtAlgorithm::from_XML(const onntinyxml2::XMLDocument &document)
   {
      const onntinyxml2::XMLElement *root_element = document.FirstChildElement("LevenbergMarquardtAlgorithm");
      ...
      const onntinyxml2::XMLElement *damping_parameter_element = root_element->FirstChildElement("DampingParameter");
      ...
      const onntinyxml2::XMLElement *minimum_damping_parameter_element = root_element->FirstChildElement("MinimumDampingParameter");
      ...
      const onntinyxml2::XMLElement *maximum_damping_parameter_element = root_element->FirstChildElement("MaximumDampingParameter");
      ...
      const onntinyxml2::XMLElement *damping_parameter_factor_element = root_element->FirstChildElement("DampingParameterFactor");
      ...
      const onntinyxml2::XMLElement *maximum_epochs_number_element = root_element->FirstChildElement("MaximumEpochsNumber");
