...
void LearningRateAlgorithmTest::test_calculate_golden_section_directional_point()
{
   ...
   pair<double, double> directional_point = tra.calculate_golden_section_directional_point(loss, training_direction, initial_learning_rate);
...
void LearningRateAlgorithmTest::test_calculate_Brent_method_directional_point()
{
   ...
   pair<double, double> directional_point = tra.calculate_Brent_method_directional_point(loss, training_direction, initial_learning_rate);
...
void LearningRateAlgorithmTest::test_to_XML()
{
   ...
   onntinyxml2::XMLDocument *document = tra.to_XML();
