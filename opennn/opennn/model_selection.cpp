...
namespace OpenNN
{
    ...
    ModelSelection::ModelSelection(const onntinyxml2::XMLDocument &model_selection_document)
    {
        training_strategy_pointer = nullptr;
        incremental_neurons_pointer = nullptr;
        growing_inputs_pointer = nullptr;
...
*/
            if (training_strategy_pointer != nullptr)
                growing_inputs_pointer->set_training_strategy_pointer(training_strategy_pointer);
        ...
        case PRUNING_INPUTS:
        {
            ...
            if (training_strategy_pointer != nullptr)
                pruning_inputs_pointer->set_training_strategy_pointer(training_strategy_pointer);
        ...
        case GENETIC_ALGORITHM:
        {
            ...
            if (training_strategy_pointer != nullptr)
                genetic_algorithm_pointer->set_training_strategy_pointer(training_strategy_pointer);
    ...
    onntinyxml2::XMLDocument *ModelSelection::to_XML() const
    {
        ostringstream buffer;
        ...
        onntinyxml2::XMLElement *model_selection_element = document->NewElement("ModelSelection");
        ...
        case NO_INPUTS_SELECTION:
        {
            onntinyxml2::XMLElement *inputs_selection_element = document->NewElement("InputsSelection");
        ...
        case GROWING_INPUTS:
        {
            ...
            const onntinyxml2::XMLDocument *growing_inputs_document = growing_inputs_pointer->to_XML();

            const onntinyxml2::XMLElement *growing_inputs_element = growing_inputs_document->FirstChildElement("GrowingInputs");

            for (const onntinyxml2::XMLNode *nodeFor = growing_inputs_element->FirstChild(); nodeFor; nodeFor = nodeFor->NextSibling())
            {
        ...
        case PRUNING_INPUTS:
        {
            ...
            const onntinyxml2::XMLDocument *pruning_inputs_document = pruning_inputs_pointer->to_XML();

            const onntinyxml2::XMLElement *pruning_inputs_element = pruning_inputs_document->FirstChildElement("PruningInputs");

            for (const onntinyxml2::XMLNode *nodeFor = pruning_inputs_element->FirstChild(); nodeFor; nodeFor = nodeFor->NextSibling())
            {
                onntinyxml2::XMLNode *copy = nodeFor->DeepClone(document);
                inputs_selection_element->InsertEndChild(copy);
            }
        ...
        case GENETIC_ALGORITHM:
        {
            ...
            const onntinyxml2::XMLDocument *genetic_algorithm_document = genetic_algorithm_pointer->to_XML();

            const onntinyxml2::XMLElement *genetic_algorithm_element = genetic_algorithm_document->FirstChildElement("GeneticAlgorithm");

            for (const onntinyxml2::XMLNode *nodeFor = genetic_algorithm_element->FirstChild(); nodeFor; nodeFor = nodeFor->NextSibling())
            {
                onntinyxml2::XMLNode *copy = nodeFor->DeepClone(document);
                inputs_selection_element->InsertEndChild(copy);
            }
        ...
        case NO_NEURONS_SELECTION:
        {
            onntinyxml2::XMLElement *neurons_selection_element = document->NewElement("NeuronsSelection");
        ...
        case INCREMENTAL_NEURONS:
        {
            ...
            const onntinyxml2::XMLDocument *incremental_order_document = incremental_neurons_pointer->to_XML();

            const onntinyxml2::XMLElement *incremental_order_element = incremental_order_document->FirstChildElement("IncrementalNeurons");

            for (const onntinyxml2::XMLNode *nodeFor = incremental_order_element->FirstChild(); nodeFor; nodeFor = nodeFor->NextSibling())
            {
                onntinyxml2::XMLNode *copy = nodeFor->DeepClone(document);
    ...
    void ModelSelection::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
    ...
    void ModelSelection::from_XML(const onntinyxml2::XMLDocument &document)
    {
        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("ModelSelection");
        ...
        // Inputs Selection
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("InputsSelection");
            ...
            if (element)
            {
                ...
                case GROWING_INPUTS:
                {
                    ...
                    onntinyxml2::XMLElement *growing_element = new_document.NewElement("GrowingInputs");
                ...
                case PRUNING_INPUTS:
                {
                    ...
                    onntinyxml2::XMLElement *pruning_element = new_document.NewElement("PruningInputs");
                ...
                case GENETIC_ALGORITHM:
                {
                    ...
                    onntinyxml2::XMLElement *genetic_element = new_document.NewElement("GeneticAlgorithm");
        ...
        // Order Selection
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("NeuronsSelection");
            ...
            if (element)
            {
                ...
                case INCREMENTAL_NEURONS:
                {
                    ...
                    onntinyxml2::XMLElement *incremental_element = new_document.NewElement("IncrementalNeurons");
