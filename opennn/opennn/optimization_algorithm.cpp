...
namespace OpenNN
{
   ...
   OptimizationAlgorithm::OptimizationAlgorithm(const onntinyxml2::XMLDocument &document)
       : loss_index_pointer(nullptr)
   {
      from_XML(document);
   }
   ...
   onntinyxml2::XMLDocument *OptimizationAlgorithm::to_XML() const
   {
      ostringstream buffer;
      ...
      onntinyxml2::XMLElement *optimization_algorithm_element = document->NewElement("OptimizationAlgorithm");
   ...
   void OptimizationAlgorithm::write_XML(onntinyxml2::XMLPrinter &file_stream) const
   {
      ostringstream buffer;
   ...
   void OptimizationAlgorithm::from_XML(const onntinyxml2::XMLDocument &document)
   {
      const onntinyxml2::XMLElement *root_element = document.FirstChildElement("OptimizationAlgorithm");
