...
namespace OpenNN
{
   ...
   MinkowskiError::MinkowskiError(const onntinyxml2::XMLDocument &mean_squared_error_document)
...
#pragma omp parallel for reduction(+ \
   ...
   onntinyxml2::XMLDocument *MinkowskiError::to_XML() const
   {
      ostringstream buffer;
      ...
      onntinyxml2::XMLElement *Minkowski_error_element = document->NewElement("MinkowskiError");

      document->InsertFirstChild(Minkowski_error_element);

      // Minkowski parameter
      {
         onntinyxml2::XMLElement *Minkowski_parameter_element = document->NewElement("MinkowskiParameter");
         Minkowski_error_element->LinkEndChild(Minkowski_parameter_element);

         buffer.str("");
         buffer << minkowski_parameter;

         onntinyxml2::XMLText *Minkowski_parameter_text = document->NewText(buffer.str().c_str());
   ...
   void MinkowskiError::write_XML(onntinyxml2::XMLPrinter &file_stream) const
   {
      ostringstream buffer;
   ...
   void MinkowskiError::from_XML(const onntinyxml2::XMLDocument &document)
   {
      const onntinyxml2::XMLElement *root_element = document.FirstChildElement("MinkowskiError");
      ...
      if (error_element)
      {
         const onntinyxml2::XMLElement *parameter_element = error_element->FirstChildElement("MinkowskiParameter");
