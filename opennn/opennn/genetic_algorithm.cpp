...
namespace OpenNN
{
    ...
    GeneticAlgorithm::GeneticAlgorithm(const onntinyxml2::XMLDocument &genetic_algorithm_document)
...
//    neural_network_pointer->set_inputs(optimal_inputs, targets_number);
    ...
    onntinyxml2::XMLDocument *GeneticAlgorithm::to_XML() const
    {
        ostringstream buffer;
        ...
        onntinyxml2::XMLElement *root_element = document->NewElement("GeneticAlgorithm");
    ...
    void GeneticAlgorithm::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        ostringstream buffer;
    ...
    void GeneticAlgorithm::from_XML(const onntinyxml2::XMLDocument &document)
    {
        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("GeneticAlgorithm");
        ...
        // Regression
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("Approximation");
        ...
        // Trials number
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("TrialsNumber");
        ...
        // Initialization method
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("InitializationMethod");
        ...
        // Crossover method
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("CrossoverMethod");
        ...
        // Fitness assignment method
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("FitnessAssignmentMethod");
        ...
        // Population size
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("PopulationSize");
        ...
        // Incest prevention distance
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("IncestPreventionDistance");
        ...
        // Mutation rate
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MutationRate");
        ...
        // Elitism size
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ElitismSize");
        ...
        // Crossover first point
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("CrossoverFirstPoint");
        ...
        // Crossover second point
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("CrossoverSecondPoint");
        ...
        // Selective pressure
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("SelectivePressure");
        ...
        // Reserve generation mean
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ReserveGenerationMean");
        ...
        // Reserve generation standard deviation
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ReserveGenerationStandardDeviation");
        ...
        // Reserve generation minimum selection
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ReserveGenerationMinimumSelection");
        ...
        // Reserve generation optimum loss
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ReserveGenerationOptimumLoss");
        ...
        // Reserve minimal parameters
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("ReserveMinimalParameters");
        ...
        // selection error goal
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("SelectionErrorGoal");
        ...
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MaximumGenerationsNumber");
        ...
        // Maximum correlation
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MaximumCorrelation");
        ...
        // Minimum correlation
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MinimumCorrelation");
        ...
        // Tolerance
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("Tolerance");
