...
namespace OpenNN
{
    ...
    void PerceptronLayer::from_XML(const onntinyxml2::XMLDocument &document)
    {
        ostringstream buffer;

        // Perceptron layer

        const onntinyxml2::XMLElement *perceptron_layer_element = document.FirstChildElement("PerceptronLayer");
        ...
        const onntinyxml2::XMLElement *neurons_number_element = perceptron_layer_element->FirstChildElement("NeuronsNumber");
        ...
        const onntinyxml2::XMLElement *inputs_number_element = perceptron_layer_element->FirstChildElement("InputsNumber");
        ...
        const onntinyxml2::XMLElement *activation_function_element = perceptron_layer_element->FirstChildElement("ActivationFunction");
        ...
        const onntinyxml2::XMLElement *parameters_element = perceptron_layer_element->FirstChildElement("Parameters");
    ...
    void PerceptronLayer::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        ostringstream buffer;
