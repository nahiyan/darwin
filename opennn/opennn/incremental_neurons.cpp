...
namespace OpenNN
{
    ...
    IncrementalNeurons::IncrementalNeurons(const onntinyxml2::XMLDocument &incremental_order_document)
    ...
    IncrementalNeurons::IncrementalNeuronsResults *IncrementalNeurons::perform_neurons_selection()
    {
        ...
        for (size_t i = 0; i < maximum_order; i++)
        {
            ...
            if (iterations == 0 || (optimum_selection_error > current_selection_error && abs(optimum_selection_error - current_selection_error) > tolerance))
            {
    ...
    onntinyxml2::XMLDocument *IncrementalNeurons::to_XML() const
    {
        ostringstream buffer;
        ...
        onntinyxml2::XMLElement *root_element = document->NewElement("IncrementalNeurons");
    ...
    void IncrementalNeurons::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        ostringstream buffer;
    ...
    void IncrementalNeurons::from_XML(const onntinyxml2::XMLDocument &document)
    {
        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("IncrementalNeurons");
        ...
        // Minimum order
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MinimumOrder");
        ...
        // Maximum order
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MaximumOrder");
        ...
        // Step
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("Step");
        ...
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("LossCalculationMethod");
