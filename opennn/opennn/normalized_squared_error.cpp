...
namespace OpenNN
{
    ...
    NormalizedSquaredError::NormalizedSquaredError(const onntinyxml2::XMLDocument &normalized_squared_error_document)
...
#pragma omp parallel for reduction(+ \
                                   : new_selection_normalization_coefficient)
...
#pragma omp critical
    ...
    onntinyxml2::XMLDocument *NormalizedSquaredError::to_XML() const
    {
        ostringstream buffer;
        ...
        onntinyxml2::XMLElement *normalized_squared_error_element = document->NewElement("NormalizedSquaredError");
    ...
    void NormalizedSquaredError::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        // Error type
    ...
    void NormalizedSquaredError::from_XML(const onntinyxml2::XMLDocument &document)
    {
        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("NormalizedSquaredError");
