...
namespace OpenNN
{
   ...
   ConjugateGradient::ConjugateGradient(const onntinyxml2::XMLDocument &conjugate_gradient_document)
   ...
   void ConjugateGradient::set_training_direction_method(const ConjugateGradient::TrainingDirectionMethod &new_training_direction_method)
   {
   ...
   Vector<double> ConjugateGradient::calculate_PR_training_direction(const Vector<double> &old_gradient, const Vector<double> &gradient, const Vector<double> &old_training_direction) const
   {
   ...
   Vector<double> ConjugateGradient::calculate_FR_training_direction(const Vector<double> &old_gradient, const Vector<double> &gradient, const Vector<double> &old_training_direction) const
   {
   ...
   Vector<double> ConjugateGradient::calculate_training_direction(const Vector<double> &old_gradient, const Vector<double> &gradient, const Vector<double> &old_training_direction) const
   {
      const NeuralNetwork *neural_network_pointer = loss_index_pointer->get_neural_network_pointer();
   ...
   OptimizationAlgorithm::Results ConjugateGradient::perform_training()
   {
      ...
      for (size_t epoch = 0; epoch <= maximum_epochs_number; epoch++)
      {
         ...
         if (epoch != 0 && abs(learning_rate) < numeric_limits<double>::min())
         {
            // Reset training direction
   ...
   onntinyxml2::XMLDocument *ConjugateGradient::to_XML() const
   {
      ostringstream buffer;
      ...
      onntinyxml2::XMLElement *root_element = document->NewElement("ConjugateGradient");
      ...
      {
         const onntinyxml2::XMLDocument *learning_rate_algorithm_document = learning_rate_algorithm.to_XML();

         const onntinyxml2::XMLElement *learning_rate_algorithm_element = learning_rate_algorithm_document->FirstChildElement("LearningRateAlgorithm");

         onntinyxml2::XMLNode *node = learning_rate_algorithm_element->DeepClone(document);
   ...
   void ConjugateGradient::write_XML(onntinyxml2::XMLPrinter &file_stream) const
   {
      ostringstream buffer;
   ...
   void ConjugateGradient::from_XML(const onntinyxml2::XMLDocument &document)
   {
      const onntinyxml2::XMLElement *root_element = document.FirstChildElement("ConjugateGradient");
      ...
      // Training direction method
      {
         const onntinyxml2::XMLElement *training_direction_method_element = root_element->FirstChildElement("TrainingDirectionMethod");
      ...
      {
         const onntinyxml2::XMLElement *learning_rate_algorithm_element = root_element->FirstChildElement("LearningRateAlgorithm");

         if (learning_rate_algorithm_element)
         {
            onntinyxml2::XMLDocument learning_rate_algorithm_document;
      ...
      // Warning parameters norm
      {
         const onntinyxml2::XMLElement *warning_parameters_norm_element = root_element->FirstChildElement("WarningParametersNorm");
      ...
      // Warning gradient norm
      {
         const onntinyxml2::XMLElement *warning_gradient_norm_element = root_element->FirstChildElement("WarningGradientNorm");
      ...
      // Warning training rate
      {
         const onntinyxml2::XMLElement *warning_learning_rate_element = root_element->FirstChildElement("WarningLearningRate");
      ...
      // Error parameters norm
      {
         const onntinyxml2::XMLElement *error_parameters_norm_element = root_element->FirstChildElement("ErrorParametersNorm");
      ...
      // Error gradient norm
      {
         const onntinyxml2::XMLElement *error_gradient_norm_element = root_element->FirstChildElement("ErrorGradientNorm");
      ...
      // Error training rate
      {
         const onntinyxml2::XMLElement *error_learning_rate_element = root_element->FirstChildElement("ErrorLearningRate");
      ...
      const onntinyxml2::XMLElement *return_minimum_selection_error_neural_network_element = root_element->FirstChildElement("ReturnMinimumSelectionErrorNN");
      ...
      const onntinyxml2::XMLElement *apply_early_stopping_element = root_element->FirstChildElement("ApplyEarlyStopping");
      ...
      // Minimum parameters increment norm
      {
         const onntinyxml2::XMLElement *minimum_parameters_increment_norm_element = root_element->FirstChildElement("MinimumParametersIncrementNorm");
      ...
      // Minimum loss decrease
      {
         const onntinyxml2::XMLElement *minimum_loss_increase_element = root_element->FirstChildElement("MinimumLossDecrease");
      ...
      // Loss goal
      {
         const onntinyxml2::XMLElement *loss_goal_element = root_element->FirstChildElement("LossGoal");
      ...
      // Gradient norm goal
      {
         const onntinyxml2::XMLElement *gradient_norm_goal_element = root_element->FirstChildElement("GradientNormGoal");
      ...
      // Maximum selection error decreases
      {
         const onntinyxml2::XMLElement *maximum_selection_error_decreases_element = root_element->FirstChildElement("MaximumSelectionErrorIncreases");
      ...
      // Maximum iterations number
      {
         const onntinyxml2::XMLElement *maximum_iterations_number_element = root_element->FirstChildElement("MaximumEpochsNumber");
      ...
      // Maximum time
      {
         const onntinyxml2::XMLElement *maximum_time_element = root_element->FirstChildElement("MaximumTime");
      ...
      // Reserve training error history
      {
         const onntinyxml2::XMLElement *reserve_training_error_history_element = root_element->FirstChildElement("ReserveTrainingErrorHistory");
      ...
      // Reserve selection error history
      {
         const onntinyxml2::XMLElement *reserve_selection_error_history_element = root_element->FirstChildElement("ReserveSelectionErrorHistory");
      ...
      // Display period
      {
         const onntinyxml2::XMLElement *display_period_element = root_element->FirstChildElement("DisplayPeriod");
      ...
      // Save period
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("SavePeriod");
      ...
      // Neural network file name
      {
         const onntinyxml2::XMLElement *element = root_element->FirstChildElement("NeuralNetworkFileName");
      ...
      // Display
      {
         const onntinyxml2::XMLElement *display_element = root_element->FirstChildElement("Display");
