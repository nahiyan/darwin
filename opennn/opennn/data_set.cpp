...
namespace OpenNN
{
    ...
    DataSet::DataSet(const onntinyxml2::XMLDocument &data_set_document)
    {
        set_default();
    ...
    void DataSet::Column::set_categories_uses(const Vector<string> &new_categories_uses)
    {
        ...
        for (size_t i = 0; i < new_categories_uses.size(); i++)
        {
            ...
            else if (new_categories_uses[i] == "Unused" || new_categories_uses[i] == "UnusedVariable")
            {
                categories_uses[i] = UnusedVariable;
            }
            else
    ...
    void DataSet::Column::from_XML(const onntinyxml2::XMLDocument &column_document)
    {
        ostringstream buffer;

        // Name

        const onntinyxml2::XMLElement *name_element = column_document.FirstChildElement("Name");

        if (!name_element)
        {
            buffer << "OpenNN Exception: DataSet class.\n"
                   << "void Column::from_XML(const onntinyxml2::XMLDocument&) method.\n"
        ...
        const onntinyxml2::XMLElement *column_use_element = column_document.FirstChildElement("ColumnUse");
        ...
        const onntinyxml2::XMLElement *type_element = column_document.FirstChildElement("Type");
        ...
        if (type == Categorical)
        {
            ...
            const onntinyxml2::XMLElement *categories_element = column_document.FirstChildElement("Categories");
            ...
            const onntinyxml2::XMLElement *categories_uses_element = column_document.FirstChildElement("CategoriesUses");
    ...
    void DataSet::Column::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        // Name
    ...
    Vector<Vector<size_t>> DataSet::get_training_batches(const bool &shuffle_batches_instances) const
    {
        ...
        if (shuffle_batches_instances)
            random_shuffle(training_indices.begin(), training_indices.end());
    ...
    Vector<Vector<size_t>> DataSet::get_selection_batches(const bool &shuffle_batches_instances) const
    {
        ...
        if (shuffle_batches_instances)
            random_shuffle(selection_indices.begin(), selection_indices.end());
    ...
    Vector<Vector<size_t>> DataSet::get_testing_batches(const bool &shuffle_batches_instances) const
    {
        ...
        if (shuffle_batches_instances)
            random_shuffle(testing_indices.begin(), testing_indices.end());
    ...
    Vector<size_t> DataSet::get_used_columns_indices() const
    {
        ...
        {
            if (columns[i].column_use == Input || columns[i].column_use == Target || columns[i].column_use == Time)
            {
                used_indices[index] = i;
                index++;
            }
    ...
    void DataSet::set_input_columns_unused()
    {
        ...
        for (size_t i = 0; i < columns_number; i++)
        {
            if (columns[i].column_use == DataSet::Input)
                set_column_use(i, UnusedVariable);
        }
    }
    ...
    void DataSet::set(const Matrix<double> &new_data)
    {
        ...
        if (get_header_line())
            set_variables_names(data.get_header());
    ...
    void DataSet::set(const onntinyxml2::XMLDocument &data_set_document)
    {
        set_default();
        ...
        for (size_t i = 0; i < input_columns_number; i++)
        {
            ...
            for (size_t j = 0; j < target_columns_number; j++)
            {
                ...
                if (input_type == Numeric && target_type == Numeric)
                {
                    ...
                    else if (abs(logarithmic_correlation.correlation) > abs(strongest_correlation.correlation))
                        strongest_correlation = logarithmic_correlation;
                    else if (abs(power_correlation.correlation) > abs(strongest_correlation.correlation))
...
#pragma omp parallel for private(current_distribution)
    ...
    void DataSet::scale_data_minimum_maximum(const Vector<Descriptives> &data_descriptives)
    {
        ...
        for (size_t i = 0; i < variables_number; i++)
        {
            if (display && abs(data_descriptives[i].maximum - data_descriptives[i].minimum) < numeric_limits<double>::min())
            {
                cout << "OpenNN Warning: DataSet class.\n"
    ...
    onntinyxml2::XMLDocument *DataSet::to_XML() const
    {
        ...
        onntinyxml2::XMLElement *data_set_element = document->NewElement("DataSet");
        ...
        onntinyxml2::XMLElement *data_file_element = document->NewElement("DataFile");
    ...
    void DataSet::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        ostringstream buffer;
    ...
    void DataSet::from_XML(const onntinyxml2::XMLDocument &data_set_document)
    {
        ostringstream buffer;

        // Data set element

        const onntinyxml2::XMLElement *data_set_element = data_set_document.FirstChildElement("DataSet");
        ...
        const onntinyxml2::XMLElement *data_file_element = data_set_element->FirstChildElement("DataFile");
        ...
        const onntinyxml2::XMLElement *data_file_name_element = data_file_element->FirstChildElement("DataFileName");
        ...
        const onntinyxml2::XMLElement *separator_element = data_file_element->FirstChildElement("Separator");
        ...
        const onntinyxml2::XMLElement *columns_names_element = data_file_element->FirstChildElement("ColumnsName");
        ...
        const onntinyxml2::XMLElement *rows_label_element = data_file_element->FirstChildElement("RowsLabel");
        ...
        const onntinyxml2::XMLElement *missing_values_label_element = data_file_element->FirstChildElement("MissingValuesLabel");
        ...
        const onntinyxml2::XMLElement *lags_number_element = data_file_element->FirstChildElement("LagsNumber");
        ...
        const onntinyxml2::XMLElement *steps_ahead_element = data_file_element->FirstChildElement("StepsAhead");
        ...
        const onntinyxml2::XMLElement *time_index_element = data_file_element->FirstChildElement("TimeIndex");
        ...
        const onntinyxml2::XMLElement *columns_element = data_set_element->FirstChildElement("Columns");
        ...
        const onntinyxml2::XMLElement *columns_number_element = columns_element->FirstChildElement("ColumnsNumber");
    ...
    const onntinyxml2::XMLElement* instances_element = data_set_element->FirstChildElement("Instances");
    ...
    const onntinyxml2::XMLElement* instances_number_element = instances_element->FirstChildElement("InstancesNumber");
...
*/
        ...
        //    const onntinyxml2::XMLElement* display_element = data_set_element->FirstChildElement("Display");
        ...
        else // More than two classes
        {
            ...
            for (size_t i = 0; i < instances_number; i++)
            {
                if (get_instance_use(i) != UnusedInstance)
                {
                    for (size_t j = 0; j < targets_number; j++)
                    {
                        if (data(i, targets_indices[j]) == static_cast<double>(NAN))
                            continue;
...
*/
    ...
    void DataSet::generate_Rosenbrock_data(const size_t &instances_number, const size_t &variables_number)
    {
        ...
        for (int i = 0; i < static_cast<int>(instances_number); i++)
        {
            ...
            {
                rosenbrock +=
                    (1.0 - data(static_cast<size_t>(i), j)) * (1.0 - data(static_cast<size_t>(i), j)) + 100.0 * (data(static_cast<size_t>(i), j + 1) - data(static_cast<size_t>(i), j) * data(static_cast<size_t>(i), j)) *
    ...
    Vector<size_t> DataSet::filter_data(const Vector<double> &minimums, const Vector<double> &maximums)
    {
        ...
        for (size_t j = 0; j < used_variables_number; j++)
        {
            ...
            for (size_t i = 0; i < current_instances_number; i++)
            {
                ...
                if (data(current_instance_index, current_variable_index) < minimums[j] || data(current_instance_index, current_variable_index) > maximums[j])
                {
