...
namespace OpenNN
{
    ...
    NeuralNetwork::NeuralNetwork(const onntinyxml2::XMLDocument &document)
    {
        from_XML(document);
    }
    ...
    Vector<Layer *> NeuralNetwork::get_trainable_layers_pointers() const
    {
        ...
        for (size_t i = 0; i < layers_number; i++)
        {
            if (layers_pointers[i]->get_type() != Layer::Scaling && layers_pointers[i]->get_type() != Layer::Unscaling && layers_pointers[i]->get_type() != Layer::Bounding)
            {
    ...
    void NeuralNetwork::set(const NeuralNetwork::ProjectType &model_type, const Vector<size_t> &architecture)
    {
        ...
        if (model_type == Approximation)
        {
            for (size_t i = 0; i < size - 1; i++)
            {
                ...
                if (i == size - 2)
                    perceptron_layer_pointer->set_activation_function(PerceptronLayer::Linear);
            }
                                                              ...
                                                              const Vector<double> &parameters) const
    {
        ...
        if (trainable_layers_pointers[0]->get_type() == OpenNN::Layer::LayerType::Pooling)
        {
            ...
            outputs = trainable_layers_pointers[0]->calculate_outputs(inputs, trainable_layers_parameters[0]);
        ...
        for (size_t i = 1; i < trainable_layers_number; i++)
        {
            if (trainable_layers_pointers[i]->get_type() == OpenNN::Layer::LayerType::Pooling)
            {
                ...
                outputs = trainable_layers_pointers[i]->calculate_outputs(outputs, trainable_layers_parameters[i]);
        }
...
*/
    ...
    onntinyxml2::XMLDocument *NeuralNetwork::to_XML() const
    {
        onntinyxml2::XMLDocument *document = new onntinyxml2::XMLDocument;

        onntinyxml2::XMLElement *neural_network_element = document->NewElement("NeuralNetwork");
        ...
        //    if(inputs_pointer)
        //    {
        //        onntinyxml2::XMLDocument* inputs_document = inputs_pointer->to_XML();

        //        const onntinyxml2::XMLElement* inputs_element = inputs_document->FirstChildElement("Inputs");

        //        onntinyxml2::XMLNode* node = inputs_element->DeepClone(document);
        ...
        //    if(outputs_pointer)
        //    {
        //        const onntinyxml2::XMLDocument* outputs_document = outputs_pointer->to_XML();

        //        const onntinyxml2::XMLElement* outputs_element = outputs_document->FirstChildElement("Outputs");

        //        onntinyxml2::XMLNode* node = outputs_element->DeepClone(document);
        ...
        //   // Display warnings
        //   {
        //      onntinyxml2::XMLElement* display_element = document->NewElement("Display");
        //      neural_network_element->LinkEndChild(display_element);

        //      buffer.str("");
        //      buffer << display;

        //      onntinyxml2::XMLText* display_text = document->NewText(buffer.str().c_str());
...
void NeuralNetwork::write_XML(onntinyxml2::XMLPrinter& file_stream) const
{
...
*/
    ...
    void NeuralNetwork::from_XML(const onntinyxml2::XMLDocument &document)
    {
        ostringstream buffer;

        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("NeuralNetwork");
        ...
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("Inputs");

            if (element)
            {
                onntinyxml2::XMLDocument inputs_document;
                onntinyxml2::XMLNode *element_clone;
        ...
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("Layers");

            if (element)
            {
                onntinyxml2::XMLDocument layers_document;
                onntinyxml2::XMLNode *element_clone;
        ...
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("Outputs");

            if (element)
            {

                onntinyxml2::XMLDocument outputs_document;
                onntinyxml2::XMLNode *element_clone;
    ...
    void NeuralNetwork::inputs_from_XML(const onntinyxml2::XMLDocument &document)
    {
        ostringstream buffer;

        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("Inputs");

        if (!root_element)
        {
            buffer << "OpenNN Exception: NeuralNetwork class.\n"
                   << "void inputs_from_XML(const onntinyxml2::XMLDocument&) method.\n"
        ...
        const onntinyxml2::XMLElement *inputs_number_element = root_element->FirstChildElement("InputsNumber");
        ...
        const onntinyxml2::XMLElement *start_element = inputs_number_element;

        if (new_inputs_number > 0)
        {
            for (size_t i = 0; i < new_inputs_number; i++)
            {
                const onntinyxml2::XMLElement *input_element = start_element->NextSiblingElement("Input");
    ...
    void NeuralNetwork::layers_from_XML(const onntinyxml2::XMLDocument &document)
    {
        ostringstream buffer;

        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("Layers");

        if (!root_element)
        {
            buffer << "OpenNN Exception: NeuralNetwork class.\n"
                   << "void layers_from_XML(const onntinyxml2::XMLDocument&) method.\n"
        ...
        const onntinyxml2::XMLElement *layers_types_element = root_element->FirstChildElement("LayersTypes");
        ...
        const onntinyxml2::XMLElement *start_element = layers_types_element;
        ...
        for (size_t i = 0; i < layers_types.size(); i++)
        {
            if (layers_types[i] == "Scaling")
            {
                ...
                const onntinyxml2::XMLElement *scaling_element = start_element->NextSiblingElement("ScalingLayer");
                start_element = scaling_element;

                if (scaling_element)
                {
                    onntinyxml2::XMLDocument scaling_document;
                    onntinyxml2::XMLNode *element_clone;
            ...
            else if (layers_types[i] == "Convolutional")
            {
                ...
                const onntinyxml2::XMLElement *convolutional_element = start_element->NextSiblingElement("ConvolutionalLayer");
                start_element = convolutional_element;

                if (convolutional_element)
                {
                    onntinyxml2::XMLDocument convolutional_document;
                    onntinyxml2::XMLNode *element_clone;
            ...
            else if (layers_types[i] == "Perceptron")
            {
                ...
                const onntinyxml2::XMLElement *perceptron_element = start_element->NextSiblingElement("PerceptronLayer");
                start_element = perceptron_element;

                if (perceptron_element)
                {
                    onntinyxml2::XMLDocument perceptron_document;
                    onntinyxml2::XMLNode *element_clone;
            ...
            else if (layers_types[i] == "Pooling")
            {
                ...
                const onntinyxml2::XMLElement *pooling_element = start_element->NextSiblingElement("PoolingLayer");
                start_element = pooling_element;

                if (pooling_element)
                {
                    onntinyxml2::XMLDocument pooling_document;
                    onntinyxml2::XMLNode *element_clone;
            ...
            else if (layers_types[i] == "Probabilistic")
            {
                ...
                const onntinyxml2::XMLElement *probabilistic_element = start_element->NextSiblingElement("ProbabilisticLayer");
                start_element = probabilistic_element;

                if (probabilistic_element)
                {
                    onntinyxml2::XMLDocument probabilistic_document;
                    onntinyxml2::XMLNode *element_clone;
            ...
            else if (layers_types[i] == "LongShortTermMemory")
            {
                ...
                const onntinyxml2::XMLElement *long_short_term_memory_element = start_element->NextSiblingElement("LongShortTermMemoryLayer");
                start_element = long_short_term_memory_element;

                if (long_short_term_memory_element)
                {
                    onntinyxml2::XMLDocument long_short_term_memory_document;
                    onntinyxml2::XMLNode *element_clone;
            ...
            else if (layers_types[i] == "Recurrent")
            {
                ...
                const onntinyxml2::XMLElement *recurrent_element = start_element->NextSiblingElement("RecurrentLayer");
                start_element = recurrent_element;

                if (recurrent_element)
                {
                    onntinyxml2::XMLDocument recurrent_document;
                    onntinyxml2::XMLNode *element_clone;
            ...
            else if (layers_types[i] == "Unscaling")
            {
                ...
                const onntinyxml2::XMLElement *unscaling_element = start_element->NextSiblingElement("UnscalingLayer");
                start_element = unscaling_element;

                if (unscaling_element)
                {
                    onntinyxml2::XMLDocument unscaling_document;
                    onntinyxml2::XMLNode *element_clone;
            ...
            else if (layers_types[i] == "Bounding")
            {
                ...
                const onntinyxml2::XMLElement *bounding_element = start_element->NextSiblingElement("BoundingLayer");

                start_element = bounding_element;

                if (bounding_element)
                {
                    onntinyxml2::XMLDocument bounding_document;
                    onntinyxml2::XMLNode *element_clone;
            ...
            else if (layers_types[i] == "PrincipalComponents")
            {
                ...
                const onntinyxml2::XMLElement *principal_components_element = start_element->NextSiblingElement("PrincipalComponentsLayer");
                start_element = principal_components_element;

                if (principal_components_element)
                {
                    onntinyxml2::XMLDocument principal_components_document;
                    onntinyxml2::XMLNode *element_clone;
    ...
    void NeuralNetwork::outputs_from_XML(const onntinyxml2::XMLDocument &document)
    {
        ostringstream buffer;

        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("Outputs");

        if (!root_element)
        {
            buffer << "OpenNN Exception: NeuralNetwork class.\n"
                   << "void outputs_from_XML(const onntinyxml2::XMLDocument&) method.\n"
        ...
        const onntinyxml2::XMLElement *outputs_number_element = root_element->FirstChildElement("OutputsNumber");
        ...
        const onntinyxml2::XMLElement *start_element = outputs_number_element;
        ...
        if (new_outputs_number > 0)
        {
            ...
            {
                const onntinyxml2::XMLElement *output_element = start_element->NextSiblingElement("Output");
    ...
    void NeuralNetwork::save(const string &file_name) const
    {
        ...
        onntinyxml2::XMLPrinter filestream(file);
