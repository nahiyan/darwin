...
namespace OpenNN
{
   ...
   public:
      ...
      explicit NeuralNetwork(const onntinyxml2::XMLDocument &);
      ...
      virtual onntinyxml2::XMLDocument *to_XML() const;
      virtual void from_XML(const onntinyxml2::XMLDocument &);
      void inputs_from_XML(const onntinyxml2::XMLDocument &);
      void layers_from_XML(const onntinyxml2::XMLDocument &);
      void outputs_from_XML(const onntinyxml2::XMLDocument &);

      virtual void write_XML(onntinyxml2::XMLPrinter &) const;
