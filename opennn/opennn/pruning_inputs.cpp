...
namespace OpenNN
{
    ...
    PruningInputs::PruningInputs(const onntinyxml2::XMLDocument &pruning_inputs_document)
    ...
    PruningInputs::PruningInputsResults *PruningInputs::perform_inputs_selection()
    {
        ...
        if (used_columns_number < maximum_epochs_number)
            maximum_epochs_number = used_columns_number;
        ...
        for (size_t epoch = 0; epoch < maximum_epochs_number; epoch++)
        {
            ...
            {
                cout << endl
                     << "Trial number: " << epoch /*trial*/ << endl;
                cout << "Training error: " << current_training_error << endl;
                cout << "Selection error: " << current_selection_error << endl;
                cout << "Stopping condition: " << training_results.write_stopping_condition() << endl
                     << endl;
            }
            ...
            if (display)
            {
                ...
                if (end_algorithm == false && epoch != 0)
...
*/
    ...
    onntinyxml2::XMLDocument *PruningInputs::to_XML() const
    {
        ostringstream buffer;
        ...
        onntinyxml2::XMLElement *root_element = document->NewElement("PruningInputs");
    ...
    void PruningInputs::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        ostringstream buffer;
    ...
    void PruningInputs::from_XML(const onntinyxml2::XMLDocument &document)
    {
        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("PruningInputs");
        ...
        // Minimum inputs number
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MinimumInputsNumber");
        ...
        // Maximum inputs number
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MaximumInputsNumber");
        ...
        // Maximum selection failures
        {
            const onntinyxml2::XMLElement *element = root_element->FirstChildElement("MaximumSelectionFailures");
