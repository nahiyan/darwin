...
namespace OpenNN
{
    ...
    MeanSquaredError::MeanSquaredError(const onntinyxml2::XMLDocument &mean_squared_error_document)
...
#pragma omp critical
    ...
    onntinyxml2::XMLDocument *MeanSquaredError::to_XML() const
    {
        ...
        onntinyxml2::XMLElement *mean_squared_error_element = document->NewElement("MeanSquaredError");
    ...
    void MeanSquaredError::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        // Error type
