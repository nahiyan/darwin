...
namespace OpenNN
{
    ...
    CrossEntropyError::CrossEntropyError(const onntinyxml2::XMLDocument &sum_squared_error_document)
    ...
    onntinyxml2::XMLDocument *CrossEntropyError::to_XML() const
    {
        ...
        onntinyxml2::XMLElement *cross_entropy_error_element = document->NewElement("CrossEntropyError");
    ...
    void CrossEntropyError::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        // Error type
    ...
    void CrossEntropyError::from_XML(const onntinyxml2::XMLDocument &document)
    {
        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("CrossEntropyError");
