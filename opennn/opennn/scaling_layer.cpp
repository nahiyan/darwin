...
namespace OpenNN
{
    ...
    void ScalingLayer::set(const onntinyxml2::XMLDocument &new_scaling_layer_document)
    {
        set_default();
    ...
    onntinyxml2::XMLDocument *ScalingLayer::to_XML() const
    {
        onntinyxml2::XMLDocument *document = new onntinyxml2::XMLDocument;

        ostringstream buffer;

        onntinyxml2::XMLElement *scaling_layer_element = document->NewElement("ScalingLayer");

        document->InsertFirstChild(scaling_layer_element);

        // Scaling neurons number

        onntinyxml2::XMLElement *size_element = document->NewElement("ScalingNeuronsNumber");
        ...
        onntinyxml2::XMLText *size_text = document->NewText(buffer.str().c_str());
        ...
        for (size_t i = 0; i < neurons_number; i++)
        {
            onntinyxml2::XMLElement *scaling_neuron_element = document->NewElement("ScalingNeuron");
            ...
            onntinyxml2::XMLElement *minimum_element = document->NewElement("Minimum");
            scaling_neuron_element->LinkEndChild(minimum_element);

            buffer.str("");
            buffer << descriptives[i].minimum;

            onntinyxml2::XMLText *minimum_text = document->NewText(buffer.str().c_str());
            minimum_element->LinkEndChild(minimum_text);

            // Maximum

            onntinyxml2::XMLElement *maximum_element = document->NewElement("Maximum");
            scaling_neuron_element->LinkEndChild(maximum_element);

            buffer.str("");
            buffer << descriptives[i].maximum;

            onntinyxml2::XMLText *maximum_text = document->NewText(buffer.str().c_str());
            maximum_element->LinkEndChild(maximum_text);

            // Mean

            onntinyxml2::XMLElement *mean_element = document->NewElement("Mean");
            scaling_neuron_element->LinkEndChild(mean_element);

            buffer.str("");
            buffer << descriptives[i].mean;

            onntinyxml2::XMLText *mean_text = document->NewText(buffer.str().c_str());
            mean_element->LinkEndChild(mean_text);

            // Standard deviation

            onntinyxml2::XMLElement *standard_deviation_element = document->NewElement("StandardDeviation");
            scaling_neuron_element->LinkEndChild(standard_deviation_element);

            buffer.str("");
            buffer << descriptives[i].standard_deviation;

            onntinyxml2::XMLText *standard_deviation_text = document->NewText(buffer.str().c_str());
            standard_deviation_element->LinkEndChild(standard_deviation_text);

            // Scaling method

            onntinyxml2::XMLElement *scaling_method_element = document->NewElement("ScalingMethod");
            scaling_neuron_element->LinkEndChild(scaling_method_element);

            buffer.str("");
            buffer << scaling_methods_string[i];

            onntinyxml2::XMLText *scaling_method_text = document->NewText(buffer.str().c_str());
            scaling_method_element->LinkEndChild(scaling_method_text);
        }

        // Scaling method

        //    onntinyxml2::XMLElement* method_element = document->NewElement("ScalingMethod");
        //    scaling_layer_element->LinkEndChild(method_element);

        //    onntinyxml2::XMLText* method_text = document->NewText(write_scaling_method().c_str());
    ...
    // void write_XML(onntinyxml2::XMLPrinter&) const method
    ...
    void ScalingLayer::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        ostringstream buffer;
    ...
    void ScalingLayer::from_XML(const onntinyxml2::XMLDocument &document)
    {
        ostringstream buffer;

        const onntinyxml2::XMLElement *scaling_layer_element = document.FirstChildElement("ScalingLayer");
        ...
        const onntinyxml2::XMLElement *neurons_number_element = scaling_layer_element->FirstChildElement("ScalingNeuronsNumber");
        ...
        const onntinyxml2::XMLElement *start_element = neurons_number_element;

        for (size_t i = 0; i < neurons_number; i++)
        {
            const onntinyxml2::XMLElement *scaling_neuron_element = start_element->NextSiblingElement("ScalingNeuron");
            ...
            const onntinyxml2::XMLElement *minimum_element = scaling_neuron_element->FirstChildElement("Minimum");
            ...
            const onntinyxml2::XMLElement *maximum_element = scaling_neuron_element->FirstChildElement("Maximum");
            ...
            const onntinyxml2::XMLElement *mean_element = scaling_neuron_element->FirstChildElement("Mean");
            ...
            const onntinyxml2::XMLElement *standard_deviation_element = scaling_neuron_element->FirstChildElement("StandardDeviation");
            ...
            const onntinyxml2::XMLElement *scaling_method_element = scaling_neuron_element->FirstChildElement("ScalingMethod");
        ...
        // Scaling method
        //    {
        //        const onntinyxml2::XMLElement* scaling_method_element = scaling_layer_element->FirstChildElement("ScalingMethod");
        ...
        // Display
        {
            const onntinyxml2::XMLElement *display_element = scaling_layer_element->FirstChildElement("Display");
