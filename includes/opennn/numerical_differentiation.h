...
namespace OpenNN
{
   ...
   public:
      ...
      template <class T>
      Vector<Matrix<double>> calculate_forward_differences_hessian(const T &t, Vector<double> (T::*f)(const Vector<double> &, const Vector<double> &) const, const Vector<double> &dummy_vector, const Vector<double> &x) const
      {
      ...
      template <class T>
      Vector<Matrix<double>> calculate_central_differences_hessian(const T &t, Vector<double> (T::*f)(const Vector<double> &, const Vector<double> &) const, const Vector<double> &dummy_vector, const Vector<double> &x) const
      {
         Vector<double> y = (t.*f)(dummy_vector, x);
      ...
      template <class T>
      Vector<Matrix<double>> calculate_hessian(const T &t, Vector<double> (T::*f)(const Vector<double> &, const Vector<double> &) const, const Vector<double> &dummy_vector, const Vector<double> &x) const
      {
         switch (numerical_differentiation_method)
         {
         case ForwardDifferences:
      ...
      template <class T>
      Vector<Matrix<double>> calculate_forward_differences_hessian(const T &t, Vector<double> (T::*f)(const size_t &, const Vector<double> &, const Vector<double> &) const, const size_t &dummy_int, const Vector<double> &dummy_vector, const Vector<double> &x) const
      {
         Vector<double> y = (t.*f)(dummy_int, dummy_vector, x);
      ...
      template <class T>
      Vector<Matrix<double>> calculate_central_differences_hessian(const T &t, Vector<double> (T::*f)(const size_t &, const Vector<double> &, const Vector<double> &) const, const size_t &dummy_int, const Vector<double> &dummy_vector, const Vector<double> &x) const
      {
         const Vector<double> y = (t.*f)(dummy_int, dummy_vector, x);
      ...
      template <class T>
      Vector<Matrix<double>> calculate_hessian(const T &t, Vector<double> (T::*f)(const size_t &, const Vector<double> &, const Vector<double> &) const, const size_t &dummy_int, const Vector<double> &dummy_vector, const Vector<double> &x) const
      {
         switch (numerical_differentiation_method)
         {
         case ForwardDifferences:
      ...
      template <class T>
      Matrix<Matrix<double>> calculate_central_differences_hessian_matrices(const T &t, Vector<double> (T::*f)(const size_t &, const Vector<double> &, const Vector<double> &) const, const size_t &dummy_int, const Vector<double> &dummy_vector, const Vector<double> &x) const
      {
         const Vector<double> y = (t.*f)(dummy_int, dummy_vector, x);
            ...
            for (size_t t = 0; t < n; t++)
            {
               ...
               for (size_t j = 0; j < n; j++)
               {
                  ...
                  for (size_t k = j; k < s; k++)
                  {
                     ...
                     H(i, t)
                     (j, k) = (y_forward_jk[i] - y_forward_j_backward_k[i] - y_backward_j_forward_k[i] + y_backward_jk[i]) / (4.0 * h_j * h_k);
                  }
               }
