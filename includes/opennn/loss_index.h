...
namespace OpenNN
{
    ...
    public:
        ...
        explicit LossIndex(const onntinyxml2::XMLDocument &);
        ...
        void regularization_from_XML(const onntinyxml2::XMLDocument &);
        void write_regularization_XML(onntinyxml2::XMLPrinter &) const;
