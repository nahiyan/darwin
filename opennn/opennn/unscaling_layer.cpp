...
namespace OpenNN
{
    ...
    UnscalingLayer::UnscalingLayer(const onntinyxml2::XMLDocument &unscaling_layer_document) : Layer()
    {
    ...
    void UnscalingLayer::set(const onntinyxml2::XMLDocument &new_unscaling_layer_document)
    {
        set_default();
    ...
    onntinyxml2::XMLDocument *UnscalingLayer::to_XML() const
    {
        ostringstream buffer;

        onntinyxml2::XMLDocument *document = new onntinyxml2::XMLDocument;

        onntinyxml2::XMLElement *unscaling_layer_element = document->NewElement("UnscalingLayer");
        ...
        for (size_t i = 0; i < neurons_number; i++)
        {
            onntinyxml2::XMLElement *statistics_element = document->NewElement("Descriptives");
    ...
    void UnscalingLayer::write_XML(onntinyxml2::XMLPrinter &file_stream) const
    {
        ostringstream buffer;
    ...
    void UnscalingLayer::from_XML(const onntinyxml2::XMLDocument &document)
    {
        ostringstream buffer;

        const onntinyxml2::XMLElement *root_element = document.FirstChildElement("UnscalingLayer");
        ...
        const onntinyxml2::XMLElement *neurons_number_element = root_element->FirstChildElement("UnscalingNeuronsNumber");
        ...
        for (size_t i = 0; i < neurons_number; i++)
        {
            const onntinyxml2::XMLElement *statistics_element = start_element->NextSiblingElement("Descriptives");
            ...
            const onntinyxml2::XMLElement *minimum_element = statistics_element->FirstChildElement("Minimum");
            ...
            const onntinyxml2::XMLElement *maximum_element = statistics_element->FirstChildElement("Maximum");
            ...
            const onntinyxml2::XMLElement *mean_element = statistics_element->FirstChildElement("Mean");
            ...
            const onntinyxml2::XMLElement *standard_deviation_element = statistics_element->FirstChildElement("StandardDeviation");
        ...
        const onntinyxml2::XMLElement *unscaling_method_element = root_element->FirstChildElement("UnscalingMethod");
